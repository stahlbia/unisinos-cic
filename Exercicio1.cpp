...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 1 -- Ana Beatriz Stahl", nullptr, nullptr);
	...
	mat4 projection = ortho(-10.0f,10.0f,-10.0f,10.0f,-1.0f,1.0f); // ortho(xmin, xmax, ymin, ymax, znear, zfar);
