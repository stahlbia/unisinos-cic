...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 5 -- Ana Beatriz Stahl", nullptr, nullptr);
    ...
    mat4 projection = ortho(0.0f, 800.0f, 600.0f, 0.0f, -1.0f, 1.0f); // ortho(xmin, xmax, ymin, ymax, znear, zfar);
